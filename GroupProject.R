...
# combined$left_eye_center_x_diff <- combined$left_eye_center_x - combined$left_eye_center_x_output
# combined$left_eye_center_y_diff <- combined$left_eye_center_y - combined$left_eye_center_y_output
# combined$right_eye_center_x_diff <- combined$right_eye_center_x - combined$right_eye_center_x_output
# combined$right_eye_center_y_diff <- combined$right_eye_center_y - combined$right_eye_center_y_output
# combined$nose_tip_x_diff <- combined$nose_tip_x - combined$nose_tip_x_output
# combined$nose_tip_y_diff <- combined$nose_tip_y - combined$nose_tip_y_output
# combined[,13:18]<-lapply(combined[,13:18],function(x){x^2})
# sum<-sapply(combined[,13:18],function(x){sum(x)})
# sqrt(mean(sum))
# sqrt(mean((combined-pred)^2, na.rm=T))
