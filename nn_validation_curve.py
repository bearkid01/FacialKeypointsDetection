...
# validation curve 
"""
def generate_validation_curve(validation_rmse,training_rmse,hyper_range,model_name):
    
    train, = plt.semilogx(hyper_range,training_rmse,label="training",color="blue", marker ="o")
    
    valid, = plt.semilogx(hyper_range,validation_rmse,label="validation",color="green", marker ="o")
    
    plt.title(model_name)
    
    plt.xlabel("Number of Nodes on the Hidden Layer")
    
    plt.ylabel("RMSE")
    
    plt.legend(handles = [train,valid],loc="lower right")
...
#train = [3.0318904995918272, 2.9214603781700133, 2.84153990149498, 2.8295450091361998, 2.6879507303237915, 2.6577300667762755, 2.6522010505199431, 2.6691989600658417]

#validation = [3.0842655301094055, 3.226891815662384, 3.2422279536724092, 3.2906492829322813, 3.4161317467689516, 3.4727912664413454, 3.4979932308197021, 3.5280938386917113]

#Num = [10,20,30,40,50,100,150,200]
